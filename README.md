...
* The Size of each combined Image (the satellite and the map image) in data-set : 1200\*600 so that means each image (map or satellite iamge) is of size 600*600
